    ...
    <div v-else class="orders-list">
      <div v-for="order in filteredOrders" :key="order.id" class="order-card">
        ...
        <div class="order-actions">
          ...
          <button v-if="order.status === 'delivered' || order.status === 'paid' || order.status === 'shipped'" class="action-btn action-btn-primary" @click="$emit('reorder', order)">
          ...
          <button class="action-btn action-btn-delete" @click="$emit('delete-order', order)">
