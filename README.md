...
- **管理员后台**：用户管理、商品管理、预约管理、数据统计
- **完整的后端API**：Spring Boot + MyBatis 构建的RESTful API
- **权限管理系统**：基于JWT的用户认证和角色权限控制
...
如有问题或建议，请通过以下方式联系：
- 项目地址：https://github.com/liang725/Pet_Service_Platform
- 开发者：liang725
