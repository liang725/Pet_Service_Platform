...
INSERT INTO `cart_items` VALUES (3,2,22,'耐咬磨牙球 发声款','https://wuyingyunshang.oss-cn-shanghai.aliyuncs.com/pet/goods/toy_2_NOLrgL3hUJg.jpg','标准装',37.31,2,'2025-12-21 13:23:31','2025-12-21 13:25:03'),(4,2,12,'智能宠物饮水机 2L容量','https://wuyingyunshang.oss-cn-shanghai.aliyuncs.com/pet/goods/supply_2_IHZdiqWOgBk.jpg','标准装',237.45,1,'2025-12-21 13:23:32','2025-12-21 13:23:32'),(5,2,27,'宠物飞盘 软胶材质','https://wuyingyunshang.oss-cn-shanghai.aliyuncs.com/pet/goods/toy_7_ZnHEa8mHOxw.jpg','标准装',23.09,1,'2025-12-21 13:24:37','2025-12-21 13:24:37');
...
CREATE TABLE `product_rating_distribution` (
  ...
  KEY `idx_product_id` (`product_id`)
) ENGINE=InnoDB AUTO_INCREMENT=168 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='商品评价分布表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-12-21 22:12:00
